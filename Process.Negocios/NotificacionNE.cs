...
namespace Process.Negocios
{
    public class NotificacionNE
    {
        ...
        public int notificacionRechazo(string _correo_destino, int _id_tarea, string _nombre_tarea, string _flujo_nombre, string _nombre_funcionario_destino, string _nombre_funcionario_origen, string _nombre_equipo, string _nombre_unidad, string _nombre_empresa, string _motivo)
        {
            //Instancia de libreria Mail
            System.Net.Mail.MailMessage auxCorreo = new System.Net.Mail.MailMessage();
            ...
            try
            {
                ...
                string _cuerpo_correo = "Estimado " + _nombre_funcionario_destino.ToUpper() + "\n\r" +
                                        ...
                                        "que pertenece al Flujo de trabajo " + _flujo_nombre.ToUpper() + ", esta tarea fue rechazada por " + _nombre_funcionario_origen.ToUpper() + " que pertenece al equipo de trabajo " + _nombre_equipo.ToUpper() + "\n\r" +
                                        "correspondiente a la Unidad " + _nombre_unidad.ToUpper() + " de la Empresa " + _nombre_empresa.ToUpper() + " ." + "\n\r" +
