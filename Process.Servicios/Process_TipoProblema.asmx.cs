...
{
    /// <summary>
    /// Descripción breve de Process_TipoProblema
    /// </summary>
    ...
    public class Process_TipoProblema : System.Web.Services.WebService
    {

        private TipoProblemaNE tipoProblemaNE = new TipoProblemaNE();
