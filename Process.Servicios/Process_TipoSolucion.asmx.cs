...
{
    /// <summary>
    /// Descripción breve de Process_TipoSolucion
    /// </summary>
    ...
    public class Process_TipoSolucion : System.Web.Services.WebService
    {

        private TipoSolucionNE tipoSolucionNE = new TipoSolucionNE();
        ...
        public void TraerTodosTipoProblema_Web()
        {
            try
            {
                CadenaConexion();
                ...
                retorno = tipoSolucionNE.TraerTodosTipoSolucion();//se envian variables

                data.tipoSolucion = retorno.Tables[0];
