...
{
    /// <summary>
    /// Descripción breve de Process_Archivo
    /// </summary>
    ...
    public class Process_Archivo : System.Web.Services.WebService
    {
        private ArchivoNE archivoNE = new ArchivoNE();
        ...
        public void InsertarArchivo_Web(string json)
        {
            try
            {
                ...
                retorno = archivoNE.InsertarArchivo(_ruta, _nombre, _id_historial_tarea);
